...
const Project = ({ type, title, img, link, github }) => {
  return (
    ...
    >
      <div
        className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] bg-dark rounded-br-3xl dark:bg-light md:-right-2
    ...
    <>
      ...
      >
        <Layout className={"pt-16"}>
          ...
          <div
            className={
              "grid grid-cols-12 gap-24 gap-y-32 xl:ga-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0"
            }
          >
